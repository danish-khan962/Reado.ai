            ...
            <div className='flex flex-col md:flex-row justify-start items-start gap-3'>
                ...
                <div className='h-full flex flex-col justify-between items-stretch gap-y-5'>
                    <div className='flex flex-col justify-start items-start gap-2.5'>
                        <h3 className='leading-snug font-medium font-merriweather text-base md:text-lg lg:text-xl group-hover:bg-green-300'> How design is changing in the digital age </h3>
