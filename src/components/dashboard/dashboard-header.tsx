...
const DashboardHeader = ({
  ...
  toggleSidebar,
    ...
    return (
        <div className='w-full flex flex-row justify-between items-center px-4 sm:px-6 md:px-8 lg:px-10 py-5 border border-b-2 border-black'>
  ...
  <h1 className="font-semibold text-4xl font-merriweather">
    Dashboard
  </h1>
</div>
